...
# -*- encoding: utf-8 -*-
# stub: link-checker 0.8.1 ruby lib

Gem::Specification.new do |s|
  s.name = "link-checker".freeze
  s.version = "0.8.1"
  ...
  s.homepage = "http://www.ryanalynporter.com/2012/10/06/introducing-the-link-checker-ruby-gem/".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.6.3".freeze
  s.summary = "Check the links in a web site before deploying.".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<anemone>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<certified>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<anemone>.freeze, [">= 0"])
      s.add_dependency(%q<certified>.freeze, [">= 0"])
